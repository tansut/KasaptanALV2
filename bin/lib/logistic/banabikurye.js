...
class BanabikuryeProvider extends core_1.LogisticProvider {
    constructor(config, options) {
        ...
        options.dispatcher.min = options.dispatcher.min || helper_1.default.asCurrency(80);
    }
    ...
    requestOffer(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let resp = this.config.cache ? (this.config.cacheType != "db" ? yield redismanager_1.default.get(cacheKey) : yield dbcache_1.default.retrieve(cacheKey, 5)) : null;
            if (!resp) {
                resp = yield this.safeResponse("calculate-order", request, req.distance, this.fromOfferResponse.bind(this));
                this.config.cache && (this.config.cacheType != "db" ? yield redismanager_1.default.set(cacheKey, resp, 5 * 60) : yield dbcache_1.default.put(cacheKey, resp));
            }
