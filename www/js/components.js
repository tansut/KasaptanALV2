             ...
             <div>
                <slot />
                    <div class="d-flex align-items-center justify-content-center">
                        <button type="button" @click="decrement()" class="btn btn-sm btn-outline rounded-lg mr-4"><i class="czi-arrow-left-circle"></i></button>
                        ...
                        <button type="button" @click="increment()" class="btn btn-sm rounded-lg btn-outline ml-4"><i class="czi-arrow-right-circle"></i></button>
                    </div>     
            </div>
              `,
        props: {
