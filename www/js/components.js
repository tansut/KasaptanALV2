                ...
                if ((!event) || event.target.checkValidity()) {
                    ...
                    return App.Backend.post(url, {
                        ...
                        this.$nextTick(function () {
                            ...
                            (typeof (fbq) != 'undefined') && fbq('track', 'AddToCart', {content_id: newItem.product.id, content_name: newItem.product.name, currency: "TRY",  value: newItem.price, content_type: 'product'});
                        })
