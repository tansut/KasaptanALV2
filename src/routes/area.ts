...
export default class Route extends ViewRouter {
    ...
    async renderPage(area: AreaModel, butchers: ButcherModel[], subs?: AreaModel[]) {
        ...
        this.res.render('pages/areal1.ejs', this.viewData({ 
            ...
            pageDescription: `Online ${this.address.display} kasaplarının en doğal ve lezzetli et ürünleri kasaptanAl.com'da. Şimdi kasaplarımızdan online et siparişi verin, kapınıza gelsin!`, 
            pageTitle: `Online ${this.address.display} Kasapları`, area: area, butchers: butchers }))
    }
