...
export default class Route extends ViewRouter {
    ...
    async ViewRoute() {
        this.renderView("pages/operator.manuelorders.ejs");
    }
    ...
    async postViewRoute() {
        ...
        if (user && !user.hasRole('admin') && !user.hasRole('operator')) {
            ...
            return this.res.redirect('/?go=' + Helper.getRandomInt(100))
    ...
    static SetRoutes(router: express.Router) {
        router.get('/manuelorders', Route.BindRequest(Route.prototype.ViewRoute))
    }
}